...
class JobRunner:
    ...
    def _process_job(self, payload: JobPayload) -> None:
        ...
        # Normalize text and add pauses.
        # XTTS: numbers only (BPE tokenizer drops stress marks).
        # VITS: full normalization with ruaccent stress and ё.
        # Both: double spaces after .!? for natural pauses.
